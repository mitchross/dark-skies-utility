 ...
 */
public class ExpandableListAdapterDaily extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterDaily(Context context)
    {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        final String key2 = groupTitlesKey.get(groupPosition);
            ...
            viewHolder.tempMinText.setText(Html.fromHtml( "Min Temp: " + day.temperatureMin + "<sup> o </sup>" +"F"));
            viewHolder.tempMinTimeText.setText("Min Temp Time: " + convertUnixTimeStampToClockTime(day.minTempTime) );
            viewHolder.tempMaxText.setText(Html.fromHtml("Max Temp:  " + day.temperatureMax + "<sup> o </sup>" +"F"));
            viewHolder.tempMaxTimeText.setText("Max Temp Time: " +String.valueOf( convertUnixTimeStampToClockTime(day.maxTempTime)));
            viewHolder.windSpeedText.setText(String.valueOf("Wind Speed: " + day.windSpeed) + "MPH");
